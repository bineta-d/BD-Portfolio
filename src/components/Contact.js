...
const Contact = () => (
	...
	>
		<hr
			className="border-none border-t border-gray-300 m-0 mb-3 w-full"
		/>
		<Container
			fluid
		...
		>
			<h2
				className="fw-bold mb-3 text-3xl text-center mb-3 text-gray-900"
			>
				Contact
			</h2>
			<div
				className="flex flex-row justify-center items-center gap-6 w-full contact-flex"
			>
				<p
					className="text-xl text-center m-0 text-gray-600 font-medium"
				>
					Feel free to reach out here:
				</p>
				<div
					className="flex gap-3 items-center mb-0 mt-0 contact-icons"
				>
					{socials.map((social) => (
						<a
							key={social.name}
